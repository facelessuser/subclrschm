...
def main():
    ...
    if _PLATFORM == "windows":
        args = Args(
            inputs.script, inputs.name, inputs.gui, inputs.clean, ".exe", path.abspath("icons\\subclrschm.ico"), inputs.portable
        )
    elif _PLATFORM == "osx":
        args = Args(
            inputs.script, inputs.name, inputs.gui, inputs.clean, '', path.abspath("icons/subclrschm.icns")
        )
    else:
        args = Args(
